    ...
    {{--<div class="col-sm-8" id="div-search">--}}
        {{--<a href="#exit" id="exit-search"><i class="fa fa-remove pull-right" aria-hidden="true"></i></a>--}}
        ...
        {{--</div>--}}
        {{--<hr>--}}
        {{--<span><button type="button" id="show-all-groups"class="btn btn-primary">Grupos registrados</button>--}}
...
{{--<hr>--}}
        ...
        {{--<div class="form-group">--}}
            ...
            {{--</div>--}}
            {{--<span><button type="button" id="search-category" class="btn btn-primary">Buscar por categoria</button><span class="error" id="error-search-category"></span></span>--}}
    {{--</div>--}}
{{--</div>--}}
