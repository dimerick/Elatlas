<div class="col-sm-8" id="div-search" style="position: absolute;" title="busqueda">
...
<button type="button" id="search-category" class="btn btn-primary">Buscar por categoria</button><span class="error" id="error-search-category"></span>
</div>
