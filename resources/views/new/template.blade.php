      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li><a id="icon-search" class="pull-left" title="Busqueda" href="#div-search" name="#div-search" rel="leanModal"><i class="fa fa-search fa-2x"></i></a></li>
...
<script src="{{ asset('assets/new/js/jquery.leanModal.min.js') }}"></script>
...
<script src="{{ asset('assets/new/js/search.js') }}"></script>
@yield('scripts')
</html>