                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if(groupsxcat != 0){
                            ...
                            content += '<div class="panel panel-default"><div class="panel-body"><div class="well well-sm well-cat"><h3>' + catActual + '</h3></div>';
    ...
    $("#show-all-groups").click(function (event) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var num = data.length;
                if(num > 0){
content += '<b>'+num + ' grupos registrados</b><hr>';
                    var descripcion;
                    for(var i= 0; i < data.length; i++){
                        descripcion = data[i].descripcion.substring(0, 41);
                        content += '<div class="row"><div class="panel panel-default"><div class="panel-body">' +
                            '<div class="col-sm-4"><img width="100%" src="/files/'+data[i].foto+'" alt="">' +
                            '</div><div class="col-sm-8"><h3>'+data[i].nombre+'</h3>' +
                            '<p>'+descripcion+'...</p>' +
                            '<p><a href="/autor/'+data[i].email+'" target="_blank" class="btn btn-primary" role="button">Ver mas</a></p></div></div></div></div>';
                    }
